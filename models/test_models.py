...
if __name__ == '__main__':
    ...
    cnn_lstm_model = tf.keras.models.load_model("best_cnn_lstm_model.h5")

    print("================================= LSTM =================================")
    test_model(lstm_model, x_train, y_train, x_test, y_test)

    print("================================= CNN ==================================")
    test_model(cnn_model, x_train, y_train, x_test, y_test)

    print("============================== CNN + LSTM ==============================")
    test_model(cnn_lstm_model, x_train, y_train, x_test, y_test)
